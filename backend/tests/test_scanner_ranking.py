...
def analysis(ticker, technical, financial, valuation):
    return {
        "ticker": ticker,
        "price": 100,
...
class ScannerRankingTests(unittest.TestCase):
    def setUp(self):
        self.analyses = [
            analysis("AAAA", 91, 94, 58),
            analysis("BBBB", 70, 80, 99),
        ]
    ...
    def test_required_scoring_combinations(self):
        cases = [
            ...
            (["technical", "financial", "valuation"], "BBBB", 83.0),
        ]
    ...
    def test_missing_selected_score_is_explicit_and_not_zero(self):
        unavailable = analysis("MISS", 90, None, 90)
